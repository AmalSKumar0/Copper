...
AST_T* parser_parse_variable_definition(parser_T* parser){
    ...
    AST_T* variable_definition = init_ast(AST_VARIABLE_DECLARATION);
    variable_definition->variable_declaration_variable_name = variable_declaration_variable_name;
